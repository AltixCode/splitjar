#!/usr/bin/env node
/**
 * Generates every brand asset for Splitjar from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"circle","cx":0.5,"cy":0.5,"r":0.41,"fill":"accent"},{"type":"rect","x":0.455,"y":0.02,"w":0.09,"h":0.96,"r":0,"fill":"ink"},{"type":"rect","x":0.3,"y":0.455,"w":0.13,"h":0.09,"r":0.045,"fill":"ink"},{"type":"rect","x":0.57,"y":0.455,"w":0.13,"h":0.09,"r":0.045,"fill":"ink"}];
 ...
 */
const MARK = [[0.12,1,1,1,0.12],[0.12,1,0.12,1,0.12],[1,1,1,1,1],[1,0.45,1,0.45,1],[1,1,1,1,1]];
...
console.log('Generating Splitjar brand assets\n');
