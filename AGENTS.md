...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs splitjar`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.splitjar` |
| Scheme | `splitjar://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.splitjar.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/splitjar` |
