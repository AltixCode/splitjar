...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.splitjar` |
| App Store Connect record | ✅ | `6812380687` — store name "Splitjar Bill Splitter" |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~2668771146` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~8279181318` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `7808408029` / `2904574869` / `6495326355`; Android `5182244683` / `3517809223` / `1591493195` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `proj05808841`, entitlement `entla8c70b3767`, offering `ofrng8ce58b811a` |
